...
| `test_voice_tuning.py` | synthesis parameters end to end, the pronunciation lexicon (whole-word, non-chaining, screen text untouched), the five-variant listening comparison, the recorded listening result |
